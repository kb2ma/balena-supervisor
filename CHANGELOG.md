...
* Use throttle for reporting state This ensures that a trailing call is executed as well as ensuring the throttle function is only ran within the allowed frequency [20k-ultra]
